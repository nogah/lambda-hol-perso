...
public class A_Lambdas {
    ...
    public void d_supplier1() {
        Supplier<StringBuilder> sup = () -> new StringBuilder().append("abc"); // TODO
    ...
    public void g_boundMethodRef1() {
        Function<String, Integer> func = s -> "abcdefghji".indexOf(s); // TODO
    ...
    public void g_boundMethodRef2() {
        Function<String, Integer> func = "abcdefghji"::indexOf; // TODO
